...
"""Genera las capturas del README a partir de la aplicación de verdad.
    ...
    python -m uvicorn backend.main:app --port 8020     # en otra consola
...
ESCENAS = [
    ("01-conteo-de-plantas", "tablero", "plantacion_top", "conteo", 16, 1500, 1000),
    ("02-malezas", "tablero", "cultivo_hileras", "malezas", 16, 1500, 1000),
    ("03-despoblamiento", "tablero", "surcos_papa", "despoblamiento", 16, 1500, 1000),
    ("04-editor-de-zonas", "editor", "plantacion_top", "conteo", 0, 1500, 1000),
]
