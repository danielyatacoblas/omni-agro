...
MODELOS = [
    ("weights/uav_weed_yolo26.pt", "Cultivo y maleza desde el aire",
     "videos/plantacion_top.mp4", 0.05),
    ("weights/yolov8s-world.pt", "Cultivos fuera del vocabulario del UAV",
     "videos/cafetal.mp4", 0.05),
]

# Lo que publica quien entrenó cada modelo, para lo que el .pt no trae.
FUENTES = {
    "uav_weed_yolo26.pt": ("Afinado sobre vistas cenitales de dron",
     None),
...
UMBRALES = [
    ("Confianza · cultivo y maleza", "0.05",
     "Desde 20 m una planta ocupa 30–120 px y el modelo nunca está seguro. Con un umbral normal se pierde medio lote. Se recoge de más y el seguimiento descarta lo que no se sostiene entre fotogramas."),
    ("Activación de ByteTrack", "0.05",
     "Igual de bajo, por lo mismo. Un umbral de seguimiento normal tiraría justo las detecciones flojas que aquí son la mayoría."),
    ("TRACK_BOOST", "sí",
     "Sube la confianza que VE el seguidor sin tocar la detección. Deja elegir por separado qué se detecta y qué merece un ID."),
]
